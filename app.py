...
st.markdown(
    ...
    .block-container {padding-top: 1rem !important; padding-left: 1rem !important; padding-right: 1rem !important; padding-bottom: 0 !important; max-width: 100% !important; overflow-x: hidden !important; margin-top: 1rem !important; margin-bottom: 0 !important;}
...
(function() {
  ...
  function buildDesignPlacement(startIdx) {
    ...
    return { name: dp.name, donorName: dp.donorName, conflict: conflict, patches: patches, colors: colors };
  }
  ...
  function handleGridClick(idx) {
    ...
    if (window.__designPlacement) {
      ...
      for (var i = 0; i < patchList.length; i++) {
        ...
        COLORS[pidx2] = placement.colors[i];
        A[pidx2] = PV;
      }
      draw();

      /* Build Zeffy URL and open it IMMEDIATELY (same user gesture) */
      ...
      /* Open Zeffy right away so popup blockers don't interfere */
      window.open(checkoutUrl, '_blank');

      /* Fire-and-forget save to Google Sheet */
      if (SCRIPT) {
        var payload = [];
        for (var i = 0; i < patchList.length; i++) {
          payload.push({patch: patchList[i], color: placement.colors[i], amount: PV, name: donorName, design: designName});
        }
        fetch(SCRIPT, {
...
(function() {
  ...
  var designs = {
    ...
    ultra: [
      ...
      {name:"Panda", px:200, desc:"Cute giant panda", grid:[
        ...
        [T,"#FFFFFF","#FFFFFF","#333333","#333333","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#333333","#333333","#FFFFFF","#FFFFFF","#FFFFFF",T],
        [T,"#FFFFFF","#333333","#333333","#FFFFFF","#333333","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#333333","#FFFFFF","#333333","#333333","#FFFFFF","#FFFFFF",T],
        [T,"#FFFFFF","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#FFFFFF","#FFFFFF",T],
        [T,T,"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF",T,T],
        [T,T,"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#333333","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF",T,T],
        [T,T,T,"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#333333","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF",T,T,T],
        [T,T,T,T,"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF",T,T,T,T],
        [T,T,T,T,T,"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF",T,T,T,T,T],
        [T,T,T,T,T,T,"#333333","#333333","#333333","#333333","#333333","#333333",T,T,T,T,T,T]]},
      ...
      {name:"Tree of Life", px:330, desc:"Majestic tree of life", grid:[
        [T,T,T,T,T,T,T,T,T,"#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,"#90BE6D","#90BE6D","#90BE6D","#7EC87E","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D","#90BE6D",T,T,T,T,T,T,T],
        [T,T,T,T,T,"#90BE6D","#90BE6D","#90BE6D","#7EC87E","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D","#90BE6D",T,T,T,T,T],
        [T,T,T,T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#B5E6A3","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T,T,T],
        [T,T,T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T,T],
        [T,T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D","#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T,T],
        [T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D",T,T,"#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T],
        [T,"#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D",T,T,T,T,"#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D",T,T,T],
        ["#90BE6D","#90BE6D","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#7EC87E","#90BE6D",T,T,T,T,T,T,"#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#B5E6A3","#7EC87E","#90BE6D","#90BE6D",T,T],
        ["#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T,T,T,T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#B5E6A3","#7EC87E","#7EC87E","#90BE6D",T,T],
        ["#90BE6D","#90BE6D","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T,T,T,T,T,T,T,"#90BE6D","#90BE6D","#7EC87E","#7EC87E","#7EC87E","#90BE6D","#90BE6D",T,T],
        [T,"#90BE6D","#90BE6D","#7EC87E","#90BE6D","#90BE6D",T,T,T,T,T,T,T,T,T,T,"#90BE6D","#90BE6D","#7EC87E","#90BE6D","#90BE6D",T,T,T],
        [T,T,"#90BE6D","#90BE6D","#90BE6D",T,T,T,T,T,"#8B4513","#8B4513","#8B4513",T,T,T,T,T,"#90BE6D","#90BE6D","#90BE6D",T,T,T],
        [T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T],
        [T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#8B4513","#D2691E","#D2691E","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T],
        [T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#8B4513",T,"#8B4513","#8B4513",T,"#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T],
        [T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#8B4513",T,T,T,T,T,T,"#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T],
        [T,T,"#8B4513","#8B4513","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T],
        [T,"#8B4513","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#8B4513","#8B4513",T,T],
        ["#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D"],
        ["#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C","#1A6B3C"]]}
    ],
    showcase: [
      {name:"Rocky (Eridian)", px:501, desc:"Rocky from Project Hail Mary - five-limbed Eridian friend", grid:[
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#D2691E","#555555","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#DEB887","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#999999","#999999","#999999","#999999","#999999",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#DEB887","#DEB887","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,"#8B4513","#8B4513","#8B4513",T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,"#8B4513","#8B4513","#8B4513",T,T,T,T,T],
        [T,T,T,"#555555","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#D2691E","#D2691E","#DEB887","#D2691E","#8B4513","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#D2691E","#555555","#8B4513",T,T,T],
        [T,T,T,"#8B4513","#DEB887","#DEB887","#DEB887","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#DEB887","#8B4513","#DEB887","#DEB887","#DEB887","#DEB887","#8B4513","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#DEB887","#DEB887","#D2691E","#8B4513",T,T,T,T],
        [T,T,T,"#8B4513","#8B4513","#D2691E","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#F8961E","#8B4513","#F8961E","#F8961E","#F8961E","#F8961E","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#D2691E","#8B4513","#8B4513",T,T,T,T],
        [T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#DEB887","#DEB887","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#DEB887","#DEB887","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T],
        [T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#DEB887","#D2691E","#DEB887","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#8B4513","#DEB887","#D2691E","#DEB887","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T],
        [T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#DEB887","#D2691E","#DEB887","#F8961E","#F8961E","#8B4513","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#DEB887","#D2691E","#DEB887","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T],
        [T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#DEB887","#D2691E","#DEB887","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#8B4513","#F8961E","#DEB887","#D2691E","#DEB887","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T],
        [T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#8B4513","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#8B4513","#F8961E","#F8961E","#F8961E","#DEB887","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T],
        [T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#F8961E","#F8961E","#8B4513","#F8961E","#F8961E","#F8961E","#F8961E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,"#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#8B4513","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513",T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#D2691E","#D2691E","#DEB887","#D2691E","#D2691E","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#DEB887","#DEB887","#DEB887","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,"#999999","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#D2691E","#D2691E","#D2691E","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#999999",T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#999999","#DEB887","#D2691E","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#8B4513","#D2691E","#DEB887","#999999","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#DEB887","#999999","#999999","#8B4513",T,T,T,T,T,T,T,"#8B4513","#999999","#999999","#DEB887","#D2691E","#8B4513",T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#8B4513","#DEB887","#D2691E","#8B4513","#999999",T,T,T,T,T,T,T,T,T,"#999999","#8B4513","#D2691E","#DEB887","#8B4513","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#D2691E","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#D2691E","#DEB887","#D2691E",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,"#555555","#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513","#555555","#8B4513",T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,"#8B4513",T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,"#8B4513",T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T],
        [T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T,T]
      ]},
      {name:"Beach Sunset", px:532, desc:"Tropical sunset beach with palm tree and ocean", grid:[
        ["#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#87CEEB","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#87CEEB"],
        ["#87CEEB","#87CEEB","#87CEEB","#1A6B3C","#90BE6D","#1A6B3C","#87CEEB","#87CEEB","#87CEEB","#FFFFFF","#FFFFFF","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#FFFFFF","#FFFFFF","#87CEEB","#87CEEB","#F9C74F","#F8961E","#F8961E","#F8961E","#F9C74F","#87CEEB"],
        ["#5BA3CF","#5BA3CF","#1A6B3C","#90BE6D","#90BE6D","#90BE6D","#1A6B3C","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#F9C74F","#F8961E","#F8961E","#F8961E","#F9C74F","#5BA3CF"],
        ["#5BA3CF","#1A6B3C","#90BE6D","#90BE6D","#5BA3CF","#5BA3CF","#5BA3CF","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#1A6B3C","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#F9C74F","#F8961E","#F8961E","#F8961E","#F9C74F","#5BA3CF"],
        ["#1A6B3C","#1A6B3C","#90BE6D","#90BE6D","#F9844A","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#90BE6D","#1A6B3C","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9844A","#F9C74F"],
        ["#FF7F50","#1A6B3C","#90BE6D","#90BE6D","#1A6B3C","#90BE6D","#90BE6D","#90BE6D","#1A6B3C","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50"],
        ["#F3722C","#1A6B3C","#1A6B3C","#8B4513","#8B4513","#D2691E","#1A6B3C","#90BE6D","#90BE6D","#90BE6D","#1A6B3C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C"],
        ["#1E5FA8","#1E5FA8","#1E5FA8","#8B4513","#D2691E","#1E5FA8","#1E5FA8","#1E5FA8","#1A6B3C","#90BE6D","#1A6B3C","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#F9844A","#F8961E","#F9844A","#1E5FA8","#1E5FA8"],
        ["#FFFFFF","#FFFFFF","#1E5FA8","#1E5FA8","#8B4513","#D2691E","#1E5FA8","#1E5FA8","#FFFFFF","#FFFFFF","#1E5FA8","#1E5FA8","#FFFFFF","#FFFFFF","#1E5FA8","#1E5FA8","#FFFFFF","#FFFFFF","#1E5FA8","#1E5FA8","#FFFFFF","#FFFFFF","#1E5FA8","#F9844A","#F8961E","#F9844A","#1E5FA8","#1E5FA8"],
        ["#277DA1","#277DA1","#277DA1","#277DA1","#8B4513","#D2691E","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1"],
        ["#277DA1","#277DA1","#FFFFFF","#FFFFFF","#8B4513","#D2691E","#277DA1","#FFFFFF","#FFFFFF","#277DA1","#277DA1","#277DA1","#FFFFFF","#FFFFFF","#277DA1","#277DA1","#277DA1","#FFFFFF","#FFFFFF","#277DA1","#277DA1","#277DA1","#FFFFFF","#FFFFFF","#277DA1","#277DA1","#277DA1","#FFFFFF"],
        ["#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#8B4513","#D2691E","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF","#5BA3CF"],
        ["#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#8B4513","#D2691E","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB","#87CEEB"],
        ["#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#8B4513","#D2691E","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF"],
        ["#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#8B4513","#D2691E","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887","#DEB887"],
        ["#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3"],
        ["#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#FF7F50","#FF7F50","#F5DEB3","#F5DEB3","#DEB887","#F5DEB3","#F5DEB3","#F5DEB3","#CCCCCC","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3"],
        ["#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#FF7F50","#FF7F50","#F5DEB3","#F5DEB3","#F5DEB3","#DEB887","#F5DEB3","#F5DEB3","#F5DEB3","#FF69B4","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3"],
        ["#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#CCCCCC","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#DEB887","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3","#F5DEB3"]
      ]},
      {name:"Log Cabin Quilt", px:484, desc:"Traditional log cabin quilt block - warm & cool spiral", grid:[
        ["#43AA8B","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E"],
        ["#43AA8B","#277DA1","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#1E5FA8","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#FF7F50","#FF7F50","#FF7F50","#FF7F50","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#F94144","#F3722C","#F94144","#FF7F50","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#F3722C","#F8961E","#F94144","#FF7F50","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#FF7F50","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#F3722C","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#F9844A","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#F8961E","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#577590","#F9C74F","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#1B3A5C","#F94144","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#1E5FA8","#FF7F50","#F3722C","#F9844A"],
        ["#43AA8B","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#277DA1","#F3722C","#F9844A"],
        ["#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#43AA8B","#F9844A"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E"]
      ]},
      {name:"Lone Star Quilt", px:484, desc:"Classic 8-pointed lone star quilt pattern", grid:[
        ["#43AA8B","#43AA8B","#43AA8B","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#43AA8B","#43AA8B","#43AA8B"],
        ["#43AA8B","#43AA8B","#43AA8B","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#F9C74F","#F9C74F","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#43AA8B","#43AA8B","#43AA8B"],
        ["#43AA8B","#43AA8B","#43AA8B","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#F9C74F","#F9C74F","#F9C74F","#F9C74F","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#43AA8B","#43AA8B","#43AA8B"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#F9C74F","#F9C74F","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F9C74F","#F9C74F","#4D908E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#F9C74F","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#F8961E","#F8961E","#F9C74F","#4D908E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#F9C74F","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#F9C74F","#4D908E","#4D908E"],
        ["#4D908E","#F9C74F","#F9C74F","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F9C74F","#F9C74F","#4D908E"],
        ["#4D908E","#F9C74F","#F9C74F","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F94144","#F94144","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F9C74F","#F9C74F","#4D908E"],
        ["#4D908E","#4D908E","#F9C74F","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#F9C74F","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F3722C","#F94144","#F94144","#F3722C","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E"],
        ["#4D908E","#4D908E","#4D908E","#4D908E","#F8961E","#F8961E","#F8961E","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F3722C","#F8961E","#F8961E","#F8961E","#4D908E","#4D908E","#4D908E","#4D908E"],
  ...
  /* Render a design grid into a canvas element */
  function renderDesignCanvas(grid, maxSize) {
    var rows = grid.length;
    var cols = 0;
    for (var r = 0; r < rows; r++) { if (grid[r].length > cols) cols = grid[r].length; }
    var cellSize = Math.floor(maxSize / Math.max(rows, cols));
    ...
    for (var r = 0; r < rows; r++) {
      for (var cc = 0; cc < grid[r].length; cc++) {
        ...
        ctx.fillStyle = grid[r][cc];
        ctx.fillRect(cc * cellSize, r * cellSize, cellSize, cellSize);
      }
    }
    return c;
  }
  ...
  function createCard(d, tier) {
    ...
    if (d.grid) {
      preview.appendChild(renderDesignCanvas(d.grid, 80));
    }
  ...
  function openDesignDetail(d, tier) {
    ...
    newCta.addEventListener('click', function(e) {
      e.preventDefault();
      var nameVal = (document.getElementById('dd-donor-name').value || '').trim();
      if (!nameVal) {
        alert('Please enter your name');
        document.getElementById('dd-donor-name').focus();
        return;
      }
      window.__designPlacement = {name: d.name, grid: d.grid, cost: cost, donorName: nameVal};
      closeDesignDetail();
  ...
  var showGrid = document.getElementById('design-grid-showcase');
  ...
  designs.showcase.forEach(function(d) { showGrid.appendChild(createCard(d, 'Showcase')); });
})();
"""
...
<div class="design-section">
  ...
  <div class="design-tier">
    <div class="design-tier-label">Showcase Designs &middot; $9,680 &ndash; $10,640</div>
    <div class="design-grid" id="design-grid-showcase"></div>
  </div>
</div>
